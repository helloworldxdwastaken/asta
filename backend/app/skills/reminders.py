...
class RemindersSkill(Skill):
    ...
    def check_eligibility(self, text: str, user_id: str) -> bool:
        ...
        return any(k in t for k in ("remind me", "wake me up", "wake up at", "alarm at", "alarm in", "alarm or reminder", "alarm", "reminder", "timer", "wake up tomorrow", "remind me tomorrow", "min from now"))
